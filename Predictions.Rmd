---
title: "Final_Project - Predicting performance for countries"
author: "Ge Gao"
output: pdf_document
---
...
```{r}
# add indicator to determine whether this athelete is come from this hosted city or not
# run clustering model to gain more insights about the relationship between medal and city
# run lda, rf for predicting future performance of the athelete from the hosted city.
```
